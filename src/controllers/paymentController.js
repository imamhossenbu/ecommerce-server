...
exports.createCheckoutSession = async (req, res) => {
    ...
    success_url: `https://ecommerce-server-pied-nine.vercel.app/api/payment/success/${transactionId}`,
    fail_url: `https://ecommerce-server-pied-nine.vercel.app/api/payment/fail/${transactionId}`,
    cancel_url: `https://ecommerce-server-pied-nine.vercel.app/api/payment/cancel/${transactionId}`,
    ipn_url: `https://ecommerce-server-pied-nine.vercel.app/api/payment/ipn`,
